                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <ul class="list-unstyled list-inline text-justify">
                                            ...
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-2.jpg" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-3.jpg" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-1.jpg" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-4.jpg" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-5.jpg" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="../resources/img/thumbs/mega-menu-6.jpg" alt="thumbs">
                                            </li>
                                        </ul>
                        ...
                        <li class="dropdown">
                            <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="lang-selected">
                                    <img class="lang-flag" src="../resources/img/flags/united-kingdom.png" alt="English">
                                </span>
                            </a>
                            ...
                            <ul class="head-list dropdown-menu">
						        ...
						        <li>
						            <!--France-->
						            <a href="#">
						                <img class="lang-flag" src="../resources/img/flags/france.png" alt="France">
						        ...
						        <li>
						            <!--Germany-->
						            <a href="#">
						                <img class="lang-flag" src="../resources/img/flags/germany.png" alt="Germany">
						        ...
						        <li>
						            <!--Italy-->
						            <a href="#">
						                <img class="lang-flag" src="../resources/img/flags/italy.png" alt="Italy">
						        ...
						        <li>
						            <!--Spain-->
						            <a href="#">
						                <img class="lang-flag" src="../resources/img/flags/spain.png" alt="Spain">
