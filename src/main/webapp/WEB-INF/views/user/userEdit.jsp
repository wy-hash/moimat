					            ...
					            <form class="panel-body form-horizontal form-padding dropzone" action="/mypage/edit" method="post" enctype="multipart/form-data" id="userForm">
					                ...
					                <!-- 관심사1 -->
					             	<div class="form-group pad-ver" >
					                	...
					                	<input type="hidden" id="memInt1" name="memInt1" />
					                	<input type="hidden" id="memInt2" name="memInt2"/>
					                	<input type="hidden" id="memInt3" name="memInt3"/>
					                </div>
	...
	for (var key in user) {
	      ...
	      if(key == "memGender"){
	    	 ...
	    	 // var ctx = window.location.pathname.substring(0, window.location.pathname.indexOf("/",2));
	    	  ...
	    	  $('#intKey').select2('val', user[key]);   	  
	      }else if(key == "memInt2"){
	    	  //$('#intKey').select2('val', user[key]).trigger("change");
	      }else if(key == "memInt3"){
	    	  //$('#intKey').select2('val', user[key]);
	      }
	}
