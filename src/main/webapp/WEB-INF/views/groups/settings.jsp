								...
								<form id="modform" class="form-horizontal form-padding" action="/modGroup" method="post">
									<div class="panel">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label text-bold">적용중인 소개사진</label>
												<div class="col-sm-9">
													<img class="img-responsive" src="${ group.teamPhoto }">
												</div>
											</div>
											...
											<div class="form-group" id="myDropzone">
												<label class="col-sm-2 control-label text-bold">소개사진변경</label>
												<div class="col-sm-9">
			...
			var myDropzone = new Dropzone('div#myDropzone', { // Make the whole body a dropzone
				...
				init: function() {
					...
					this.on('sending', function(file, xhr, formData) {
						...
						formData.append('teamId', ${ group.teamId });
					});
