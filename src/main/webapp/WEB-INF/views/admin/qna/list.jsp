           		...
           		<!--목록 뷰-->
					...
					<div class="panel">
						...
						<div class="panel-body">
							<form id="actionForm" class="form-inline pull-right mar-btm" action="/admin/qna" method="post">
...
<%-- 											<td>${list.postContent}</td> --%>
							...
							<nav aria-label="Page navigation">
								...
								<button id="newQna" type="button" class="btn btn-success pull-right mar-top"><i class="demo-pli-plus"></i> 게시판 추가</button>	
							</nav>
						</div>
	...
	<script>
		$(document).ready(function(){
			$('#newQna').on('click', function(){
				let url = location.origin+'/admin/qna/new';
				location.href = url;
			});
			
			$('.view').on('click', function(){
				let id = this.dataset.id;
				let url = location.origin+'/admin/qna/view/'+id;
				location.href = url;
			});
