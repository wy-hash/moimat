				...
				<div id="page-content">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">이벤트 작성</h3>
						</div>
						<form id="eventForm" name="eventForm" action="/admin/event/new"
							class="panel-body form-horizontal form-padding" method="post">
							<input type="hidden" id="postId" name="brdId" value="2"><!-- 추후 el태그로 이용할 예정 -->
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" id="postNum" name="postNum" class="form-control"
										placeholder="이벤트를 상단에 먼저 보이게 하려면 숫자를 높게 설정하세요. 숫자만 입력 가능합니다.">
	...
	<script>
		$(document).ready(function () {
			...
			$('#postCansel').on('click', function () {
				let url = location.origin + '/admin/event/list';
				location.href = url;
			});
