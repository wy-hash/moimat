...
<body>
			...
			<div id="content-container">
				...
				<div id="page-content">
					...
					<div class="panel">
						...
						<form id="interestForm" name="interestForm" action="/admin/interest/edit"
	...
	<script>
		...
		function validation() {
			...
			$('#intKey').on(
					...
					function() {
						...
						let intKeyPrev = $("#intKeyPrev").val();
						let intKeyVal = $("#intKey").val();
						
						if (intKeyPrev !== intKeyVal){
		...
		function submitCheck() {
			...
			// 폼 입력 체크
			//기존 관심사 코드와 다른 경우에만 DB중복조회를 하도록.
			if (intKeyPrev !== intKey){
